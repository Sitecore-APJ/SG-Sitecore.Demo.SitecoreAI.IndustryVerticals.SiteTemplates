...
export const Default = (props: BreadcrumbProps) => {
  ...
  return (
    <nav
      ...
      className={`component breadcrumb border-border bg-background-muted border-b ${styles}`}
      id={id}
    >
      <ol className="container flex items-center gap-4 overflow-auto py-4 lg:py-7">
        {homeAncestor && (
          <li key={homeAncestor.id} className="text-foreground-light flex items-center gap-4">
            <Link
              ...
              className="hover:text-accent text-foreground-light whitespace-nowrap no-underline transition-colors"
        ...
        <li
          className="border-accent text-foreground border-l py-2 pl-4 text-sm font-semibold whitespace-nowrap lg:ml-4 lg:pl-8"
