...
export const Default = (props: BreadcrumbProps) => {
  ...
  return (
    <nav
      ...
      id={id}
    >
      <ol className="container flex items-center gap-3 overflow-auto py-3 text-xs lg:py-4">
        {homeAncestor && (
          <li key={homeAncestor.id} className="text-foreground-light flex items-center gap-4">
            <Link
              field={homeAncestor.url}
              className="hover:text-accent text-foreground-light whitespace-nowrap transition-colors"
