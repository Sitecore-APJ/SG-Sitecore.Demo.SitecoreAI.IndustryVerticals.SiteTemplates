          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:bg-background lg:border-border/80 lg:rounded-md lg:border lg:shadow-lg',
                isActive
                  ? 'max-lg:flex'
...
export const Default = ({ params, fields }: NavigationProps) => {
  ...
  return (
    <div
      className={`component navigation bg-background border-border/80 border-b ${styles}`}
      id={id}
    >
      <div
        className={clsx(
