    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="hover:text-accent text-foreground text-sm font-medium whitespace-nowrap no-underline transition-colors"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:bg-background lg:border-border lg:min-w-48 lg:rounded-sm lg:border lg:shadow-md',
                isActive
                  ? 'max-lg:flex'
    ...
    <div className={`component navigation bg-background ${styles}`} id={id}>
      ...
      >
        <ul
          role="menubar"
          className={clsx(
            'container flex flex-col items-center justify-center gap-x-6 gap-y-4 py-6 text-base font-medium lg:flex-row xl:gap-x-10',
