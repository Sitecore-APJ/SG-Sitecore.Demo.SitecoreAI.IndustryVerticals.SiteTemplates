  ...
  return (
    <PreviewSearch.Root>
      <form ref={formRef} onSubmit={handleSubmit} className="flex-1">
        <PreviewSearch.Input
          name="query"
          className="focus:ring-accent/30 border-border shadow-card focus:border-accent w-full rounded-full border px-5 py-3 text-base focus:ring-2 focus:outline-none sm:px-6 sm:py-3.5 sm:text-lg"
