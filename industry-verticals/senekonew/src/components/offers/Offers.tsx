...
export const Default = (props: OfferProps) => {
  ...
  return (
    <div className={`component offers bg-primary text-white ${styles}`} id={id}>
      <div className="mx-auto flex w-full max-w-3xl items-center justify-center gap-5 p-2 py-3">
        <button
