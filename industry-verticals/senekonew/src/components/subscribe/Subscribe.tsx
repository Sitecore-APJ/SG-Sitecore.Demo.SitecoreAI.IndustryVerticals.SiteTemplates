          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="bg-background ring-border text-foreground placeholder:text-foreground-muted focus:ring-primary/30 h-12 w-full rounded-full ps-5 pe-32 ring-1 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="bg-accent hover:bg-accent-hover group-[.container-dark-background]:bg-background-accent group-[.container-dark-background]:!text-foreground absolute top-1/2 right-2 h-9 -translate-y-1/2 rounded-full px-4 text-sm font-semibold text-white focus-visible:ring-2 focus-visible:outline-none md:right-3 md:h-10 md:px-5"
              >
      ...
      <div className="max-w-sm">
        ...
        <form className="w-full" action="">
          ...
          <input
            ...
            className="bg-background text-foreground placeholder:text-foreground-muted ring-border focus:ring-primary/30 h-12 w-full rounded-lg ps-5 pe-5 ring-1 focus:ring-2 focus:outline-none md:h-14"
          />

          <button
            type="submit"
            className="bg-accent hover:bg-accent-hover group-[.container-dark-background]:bg-background-accent group-[.container-dark-background]:!text-foreground mt-3 inline-flex h-12 w-full items-center justify-center rounded-full font-semibold text-white md:h-12"
          >
            {t('button_text') || 'Subscribe'}
          </button>
