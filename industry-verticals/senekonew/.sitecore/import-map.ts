...
import { ArrowRight, ChevronLeft, ChevronRight, ChevronDown, Heart, Plus, Star, User, X, Search, Check, Loader2, LoaderCircle, ShoppingCart, Globe, MoreHorizontal, Home } from 'lucide-react';
...
const importMap = [
  ...
  {
    module: '@/components/non-sitecore/HeaderUtilityBar',
    exports: [
      { name: 'HeaderUtilityBar', value: HeaderUtilityBar },
    ]
  },
  {
