    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="hover:text-foreground-light text-xs font-medium tracking-[0.16em] whitespace-nowrap uppercase transition-colors lg:text-[11px] xl:text-xs"
        >
      ...
      {hasChildren && (
        <ul
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                'z-110 text-xs tracking-[0.14em] uppercase max-lg:border-b max-lg:pb-4',
                'lg:border-border lg:absolute lg:top-full lg:left-1/2 lg:-translate-x-1/2 lg:border lg:p-5 lg:transition-all lg:duration-300',
                'lg:bg-background lg:rounded-none lg:shadow-none',
                isActive
                  ? 'max-lg:flex'
    ...
    <div className={`component navigation bg-background ${styles}`} id={id}>
      ...
      >
        <ul
          role="menubar"
          className={clsx(
            'container flex flex-col items-center justify-center gap-x-6 gap-y-5 py-8 text-sm tracking-[0.16em] uppercase lg:flex-row lg:py-5 xl:gap-x-10',
