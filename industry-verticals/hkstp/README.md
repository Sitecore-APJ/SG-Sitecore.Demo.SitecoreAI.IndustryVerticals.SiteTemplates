...
HKSTP is a SitecoreAI demo site restyled to match the visual identity and UX feel of [Hong Kong Science & Technology Parks Corporation](https://www.hkstp.org/en/). It showcases an innovation & technology ecosystem experience with Montserrat typography, brand orange/blue accents, clean corporate navigation, and editorial content patterns.
...
- Brand tokens aligned to HKSTP (orange `#FF6E10`, blue `#035CE1`, Montserrat)
...
6. Install dependencies:
   from `industry-verticals\hkstp` run `npm install`
...
#### By default, the hkstp site supports the following locales:
- en (English)
- fr-FR (French)
- es-ES (Spanish)
