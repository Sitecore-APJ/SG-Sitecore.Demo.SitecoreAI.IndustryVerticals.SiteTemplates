...
export const MockPlaceholder = ({ className = '' }: MockPlaceholderProps) => {
  return (
    <div className="sc-jss-empty-placeholder">
      <div
        className={`flex h-25 w-full min-w-12 cursor-pointer items-center justify-center border-2 border-dashed border-[#969696] bg-white/60 p-5 hover:bg-[#fff4eb] ${className}`}
      >
