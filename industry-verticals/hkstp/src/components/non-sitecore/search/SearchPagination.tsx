  ...
  return (
    ...
    >
      <Pagination.PrevPage
        ...
        className="bg-background-accent rounded-full px-3 py-2 font-semibold data-[current=true]:hidden md:px-4 md:py-2.5"
      >
          ...
          Pagination.paginationLayout(pagination, {
            ...
            type === 'page' ? (
              <Pagination.Page
                ...
                page={page as number}
                onClick={(e) => e.preventDefault()}
                className={`mx-1 rounded-full px-3 py-2 font-semibold md:px-4 md:py-2.5 ${
