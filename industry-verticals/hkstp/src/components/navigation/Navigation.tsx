    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="hover:text-accent text-sm font-bold tracking-wide whitespace-nowrap transition-colors lg:text-[15px]"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:border-border lg:bg-background lg:rounded-lg lg:border lg:shadow-lg',
                isActive
                  ? 'max-lg:flex'
    ...
    <div className={`component navigation bg-background ${styles}`} id={id}>
      ...
      >
        <ul
          role="menubar"
          className={clsx(
            'container flex flex-col items-center justify-center gap-x-5 gap-y-4 py-6 text-base font-bold lg:flex-row xl:gap-x-8',
