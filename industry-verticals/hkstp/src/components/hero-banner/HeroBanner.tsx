          ...
          >
            <div className="max-w-182">
              <div className={clsx({ shim: screenLayer })}>
                {/* Title */}
                <h1 className="text-center text-4xl leading-[110%] font-extrabold tracking-tight text-white uppercase md:text-6xl md:leading-[120%] lg:text-left xl:text-[72px]">
                  <ContentSdkText field={fields.Title} />
                  {!hideAccentLine && (
                    <AccentLine className="text-accent mx-auto !h-4 w-[9ch] lg:mx-0" />
                  )}
                </h1>
                ...
                <div className="mt-8 flex w-full justify-center lg:justify-start">
                  {withPlaceholder ? (
                    ...
                    <Link field={fields.CtaLink} className="main-btn !w-auto px-8" />
                  )}
                </div>
              </div>
            </div>
      ...
      <div className="relative w-full">
        <div className="container mx-auto flex min-h-238 justify-center px-4">
          ...
          >
            <div className={clsx({ shim: screenLayer })}>
              {/* Title */}
              <h1 className="text-center text-4xl leading-[110%] font-extrabold tracking-tight text-white uppercase md:text-6xl md:leading-[120%] xl:text-[72px]">
                <ContentSdkText field={fields.Title} />
                {!hideAccentLine && <AccentLine className="text-accent mx-auto !h-4 w-[9ch]" />}
              </h1>
