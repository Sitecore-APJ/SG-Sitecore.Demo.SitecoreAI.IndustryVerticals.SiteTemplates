...
export const Default = (props: HeaderProps): JSX.Element => {
  ...
  return (
    <div
      className={`component header border-border bg-background sticky top-0 z-50 border-b ${styles}`}
      id={id}
    >
      <div className="container flex min-h-16 items-center gap-3 py-3 lg:min-h-20 lg:gap-6 lg:py-4">
