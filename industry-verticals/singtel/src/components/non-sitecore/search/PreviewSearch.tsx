  ...
  return (
    <PreviewSearch.Root>
      <form ref={formRef} onSubmit={handleSubmit} className="flex-1">
        <PreviewSearch.Input
          name="query"
          className="focus:ring-accent border-border w-full rounded-full border px-5 py-3 text-base focus:border-transparent focus:ring-2 focus:outline-none sm:px-6 sm:py-3.5"
