...
export const Default = (props: BreadcrumbProps) => {
  ...
  return (
    <nav
      ...
      className={`component breadcrumb bg-background-muted border-border border-b ${styles}`}
      id={id}
    >
      <ol className="container flex items-center gap-3 overflow-auto py-3 text-sm lg:gap-4 lg:py-4">
        {homeAncestor && (
          <li key={homeAncestor.id} className="text-foreground-light flex items-center gap-4">
            <Link
              ...
              className="text-link hover:text-accent whitespace-nowrap transition-colors"
        ...
        <li
          className="border-accent text-foreground border-l py-1 pl-4 font-medium whitespace-nowrap lg:ml-2 lg:pl-6"
