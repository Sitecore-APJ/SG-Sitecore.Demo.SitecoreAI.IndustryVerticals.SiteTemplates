          ...
          <div className="gap flex items-center gap-x-7">
            <div>
              ...
              <input
                type="number"
                id="items-per-page"
                className="bg-background border-border text-foreground-light size-12 rounded-full border text-center text-base [&::-webkit-inner-spin-button]:appearance-none"
                value={displayCount}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <div className="relative">
                <select
                  id="sort-by"
                  className="bg-background text-foreground-light border-border h-12 w-full appearance-none rounded-full border px-6 pr-14 text-base"
                  value={sortOption}
