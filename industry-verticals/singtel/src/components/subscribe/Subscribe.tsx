    ...
    >
      <div className="container max-w-4xl md:max-w-5xl md:px-10">
        <div className="grid items-center gap-y-6 md:grid-cols-2 md:gap-x-12 md:gap-y-0">
          {/* Headline */}
          <h2 className="font-heading text-foreground text-2xl leading-tight font-normal xl:text-3xl">
          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="bg-background text-foreground ring-border placeholder:text-foreground-muted focus:ring-accent h-12 w-full rounded-full ps-5 pe-36 ring-1 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="bg-accent text-background hover:bg-accent-dark absolute top-1/2 right-2 h-9 -translate-y-1/2 rounded-full px-5 text-sm font-semibold transition-colors focus-visible:ring-2 focus-visible:outline-none md:right-3 md:h-10 md:px-6"
              >
      ...
      <div className="max-w-sm">
        ...
        <form className="w-full" action="">
          ...
          <input
            ...
            className="bg-background text-foreground placeholder:text-foreground-muted ring-border focus:ring-accent h-12 w-full rounded-full ps-5 pe-5 ring-1 focus:ring-2 focus:outline-none md:h-14"
          />

          <button
            type="submit"
            className="bg-accent text-background hover:bg-accent-dark mt-3 inline-flex h-12 w-full items-center justify-center rounded-full font-semibold transition-colors md:h-12"
          >
            {t('button_text') || 'Subscribe'}
          </button>
