    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="hover:text-accent font-body text-sm font-medium whitespace-nowrap transition-colors"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:bg-background lg:border-border lg:rounded-2xl lg:border lg:shadow-sm',
                isActive
                  ? 'max-lg:flex'
    ...
    <div className={`component navigation bg-background ${styles}`} id={id}>
      ...
      >
        <ul
          role="menubar"
          className={clsx(
            'container flex flex-col items-center justify-center gap-x-6 gap-y-3 py-6 text-sm font-medium lg:flex-row xl:gap-x-10',
